...
* [@aeternity/aepp-sdk/es/ae/contract](#module_@aeternity/aepp-sdk/es/ae/contract)
    ...
    * _async_
        ...
        * [contractCallStatic(source, address, name, args, options, top, bytecode, options)](#exp_module_@aeternity/aepp-sdk/es/ae/contract--contractCallStatic) ⇒ `Promise.&lt;Object&gt;` ⏏
...
### contractCallStatic(source, address, name, args, options, top, bytecode, options) ⇒ `Promise.&lt;Object&gt;` ⏏
